package com.jh.android_animation;
...
/**
 * Android中最常见的四种动画效果，如淡入淡出，翻转动画，平移动画 帧动画 和属性动画，以及各种动画效果的叠加使用
 * https://www.imooc.com/learn/379
 */
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.change: {
                ...
                overridePendingTransition(R.anim.zoom_in, R.anim.zoom_out); // android 2.0之后
                break;
            }
            case R.id.layout: {
